...
> **Skill:** For detailed governance procedures, decision flowcharts, and WS structure templates, see `.claude/skills/combine-governance/SKILL.md`
...
> **Skill:** For Do No Harm audit procedure, phase execution detail, and remediation WS patterns, see `.claude/skills/ws-execution/SKILL.md`
...
> **Skill:** For worked examples, report format templates, and escalation decision tree, see `.claude/skills/autonomous-bug-fix/SKILL.md`
...
> **Skill:** For parallelism detection examples, allowed_paths isolation test, and WP-DCW-001 dispatch walkthrough, see `.claude/skills/subagent-dispatch/SKILL.md`
...
> **Skill:** For endpoint formats, event_id generation, pinned enum reference, JSON templates, and scoreboard details, see `.claude/skills/metrics-reporting/SKILL.md`
...
> **Skill:** For Tier 0 command variants, WS mode with --scope, and result interpretation, see `.claude/skills/tier0-verification/SKILL.md`
...
> **Skill:** For full session log template, backfill procedure, and PROJECT_STATE update checklist, see `.claude/skills/session-management/SKILL.md`
