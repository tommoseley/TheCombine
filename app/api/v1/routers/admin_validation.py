    ...
    return {
        "tiers": {
            "commit": {
                ...
                "order": [
                    "1. Manifest presence + YAML validity",
                    "2. Required fields",
                    "3. Authority/creation mode rules (PGC required)",
                    "4. Artifact existence",
                    "5. Role/template ref resolution",
                ],
            },
            "activation": {
                ...
                "order": [
                    "1. Extracted-doc forbidden",
                    "2. Required inputs active",
                    "3. Schema break detection",
                ],
            },
        },
        "rules": [
            # Tier 1: Commit-time blockers (repository integrity)
            # Order: manifest -> fields -> authority rules -> artifacts -> refs
            {
            ...
            },
            {
                ...
                "severity": "error",
                "applies_to": ["package"],
                "description": "Descriptive/Prescriptive documents require PGC context (manifest-decidable)",
            },
            {
