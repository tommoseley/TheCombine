...
async def test_template(request: Request):
    ...
    <div style="padding: 20px; border: 2px solid green; margin: 20px;">
        <h1>ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ Plain HTML works!</h1>
...
async def test_template_engine(request: Request):
    ...
    try:
        return templates.TemplateResponse(request, "public/pages/project_detail.html", {
                "project": {
                    "id": "test-123",
                    "project_id": "TEST",
                    "name": "Test Project",
        ...
        <div style="padding: 20px; border: 2px solid red; margin: 20px;">
            <h1>ÃƒÂ¢Ã…â€œÃ¢â‚¬â€ Template Error</h1>
            <pre>{str(e)}</pre>
            <h2>Traceback:</h2>
...
async def test_db(request: Request, db: AsyncSession = Depends(get_db)):
    ...
    try:
        ...
        <div style="padding: 20px; border: 2px solid green;">
            <h1>ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“ Database Works!</h1>
        ...
        <div style="padding: 20px; border: 2px solid red;">
            <h1>ÃƒÂ¢Ã…â€œÃ¢â‚¬â€ Database Error</h1>
            <pre>{str(e)}</pre>
            <pre>{traceback.format_exc()}</pre>
        </div>
        """