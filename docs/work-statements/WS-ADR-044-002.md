...
1. Modal dialog with fields: ID (identifier), Kind (dropdown), Name
...
1. Modal dialog with fields: ID (identifier), Name, Purpose (dropdown)
...
1. Modal dialog with fields: ID (identifier), Name
