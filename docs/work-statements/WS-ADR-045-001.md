...
- [ ] Left rail shows three abstraction-level groups (Production Workflows, Building Blocks, Governance)
- [ ] Document Workflows and Project Workflows are visually separated
- [ ] Tasks section lists all task prompts and navigates to correct editor
- [ ] Schemas section lists all schemas (standalone and/or packaged)
- [ ] At least one schema extracted to `combine-config/schemas/` and referenced by its document type package
- [ ] Package loader resolves standalone schema references
- [ ] All existing navigation paths still work
- [ ] CLAUDE.md references ADR-045 taxonomy
- [ ] WS-INVENTORY.md updated
