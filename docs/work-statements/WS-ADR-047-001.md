...
- [ ] types.yaml validates against mech-op-registry schema
- [ ] MechanicalOpsService loads types and instances
- [ ] ExtractorHandler extracts fields with JSONPath
- [ ] MergerHandler merges with all strategies
- [ ] API endpoints return types and instances
- [ ] Building Blocks tray has Mechanical Ops tab
- [ ] Types display grouped by category
- [ ] NodePropertiesPanel detects internal_type
- [ ] MECH nodes show operation dropdown
- [ ] pgc_clarification_merge operation loads correctly
- [ ] All existing tests pass
- [ ] No regressions in LLM node configuration
