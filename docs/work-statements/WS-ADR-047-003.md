...
- [ ] Audit table completed with all candidates
- [ ] High-priority operations created
- [ ] Operations load via API
- [ ] Operations appear in Building Blocks
- [ ] Handlers refactored to use operations
