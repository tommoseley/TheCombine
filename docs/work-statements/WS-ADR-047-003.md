...
**Status:** In Progress (Phases 1-2 complete, Phases 3-5 deferred)
**Created:** 2026-02-06
...
- [ ] Handlers refactored to use operations (deferred - requires code changes)
- [ ] Workflow definitions updated (deferred - requires handler work first)
