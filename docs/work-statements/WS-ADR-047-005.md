...
- [ ] IntakeGateExecutor uses Gate execution pattern
- [ ] LLM classification executes with intake_gate task prompt
- [ ] Entry operation pauses for operator confirmation
- [ ] Invariant pinning executes after confirmation
- [ ] Special-case code removed from plan_executor.py
- [ ] All existing tests pass
- [ ] End-to-end intake workflow works correctly
