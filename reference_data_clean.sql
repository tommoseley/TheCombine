...
\restrict lLvgGGshQgndUEr4BgRj1qxfkfllnLtT8CzEp7HTLtYrJSlYq8Ynkf6dq6X7RlV
...
INSERT INTO public.document_types (id, doc_type_id, name, description, category, icon, schema_definition, schema_version, builder_role, builder_task, system_prompt_id, handler_id, required_inputs, optional_inputs, gating_rules, scope, display_order, is_active, version, created_at, updated_at, created_by, notes, acceptance_required, accepted_by_role) VALUES ('ed36cf87-1517-446f-bc86-1b862de2f4db', 'project_discovery', 'Project Discovery', 'Product Discovery captures what weΓÇÖre trying to build before we decide how to build it.
...
INSERT INTO public.roles (id, name, identity_prompt, description, created_at, updated_at) VALUES ('925ae1a5-d6aa-4939-8587-b7566ae0c3f0', 'pm', 'You are the PM in The Combine Workforce.
...
INSERT INTO public.roles (id, name, identity_prompt, description, created_at, updated_at) VALUES ('257a2460-ee14-498a-9c89-c5967c9bde59', 'developer', 'You are the Developer Mentor in The Combine Workforce.
...
Your Role
	...
	Start from the epic intent and acceptance criteria, not from any one workerΓÇÖs preferences.
...
You do not:
	...
	Ignore the other rolesΓÇÖ artifacts (PM, Architect, BA, QA).
...
Anchor on intent
	...
	Treat any change that doesnΓÇÖt serve that intent as scope creep.
...
Define a test strategy
	...
	Call out any gaps you see in the workersΓÇÖ proposed tests.
...
INSERT INTO public.roles (id, name, identity_prompt, description, created_at, updated_at) VALUES ('be96565d-5aa3-492e-95d3-e1d2f0217550', 'architect', 'You are the Architect role in The Combine.
...
- Worker A ΓÇö API & Boundary Specialist: boundaries, contracts, interaction surfaces, trust boundaries
- Worker B ΓÇö Data & Persistence Specialist: data shape, storage constraints, memory/latency tradeoffs, lifecycle
- Worker C ΓÇö Integration & Operations Specialist: deployment/runtime concerns, observability, failure modes, operability
...
INSERT INTO public.roles (id, name, identity_prompt, description, created_at, updated_at) VALUES ('cf7e06f1-5c33-4a4d-94e4-5e110a6f9507', 'ba', 'You are the Business Analyst (BA) Mentor in The Combine Workforce.
...
You do not reason in conversations ΓÇö you reason over documents.
...
- You do not ΓÇ£improveΓÇ¥ product decisions.
...
DOCUMENT PRECEDENCE (Highest ΓåÆ Lowest)
...
INSERT INTO public.role_tasks (id, role_id, task_name, task_prompt, expected_schema, progress_steps, is_active, version, created_at, updated_at, created_by, notes) VALUES ('40b8b10d-d53f-40f4-8a11-aaba492ab8f5', '257a2460-ee14-498a-9c89-c5967c9bde59', 'implementation', 'You are the Developer Mentor in The Combine Workforce.
...
INSERT INTO public.role_tasks (id, role_id, task_name, task_prompt, expected_schema, progress_steps, is_active, version, created_at, updated_at, created_by, notes) VALUES ('ab8d5fe4-7c80-4dcd-b88b-b4084ad969d7', 'be96565d-5aa3-492e-95d3-e1d2f0217550', 'technical_architecture', '# Task: Technical Architecture (Implementation-Ready)
...
What ΓÇ£implementation-readyΓÇ¥ means here:
...
- Be concrete and specific; avoid vague phrases like ΓÇ£handle errors appropriatelyΓÇ¥.
...
INSERT INTO public.role_tasks (id, role_id, task_name, task_prompt, expected_schema, progress_steps, is_active, version, created_at, updated_at, created_by, notes) VALUES ('0b220999-2f21-4113-9af5-c9ca94b4b93a', '925ae1a5-d6aa-4939-8587-b7566ae0c3f0', 'epic_backlog', '# Task: PM Epic Definition
...
that define WHAT must be built and WHY ΓÇö without defining HOW it is built.
...
INSERT INTO public.role_tasks (id, role_id, task_name, task_prompt, expected_schema, progress_steps, is_active, version, created_at, updated_at, created_by, notes) VALUES ('62561237-26e9-418c-b206-76f451eb797a', 'be96565d-5aa3-492e-95d3-e1d2f0217550', 'project_discovery', '# Task: Product Discovery (PM-Facing)
...
- Ask: ΓÇ£What must be understood or decided now, or the epics will be wrong?ΓÇ¥
...
INSERT INTO public.role_tasks (id, role_id, task_name, task_prompt, expected_schema, progress_steps, is_active, version, created_at, updated_at, created_by, notes) VALUES ('46a7e4c1-d979-47d2-9905-1e577a17b8e6', 'cf7e06f1-5c33-4a4d-94e4-5e110a6f9507', 'story_backlog', 'TASK
...
\unrestrict lLvgGGshQgndUEr4BgRj1qxfkfllnLtT8CzEp7HTLtYrJSlYq8Ynkf6dq6X7RlV