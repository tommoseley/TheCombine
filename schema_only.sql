...
\restrict tSzIgJQzebDhdyQWIexuEuWGAd22rZ85nyuabohifXIURt36X5EM4tZb4UENeeE
...
--
-- Name: get_artifact_with_ancestry(character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_artifact_with_ancestry(path character varying); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: parse_artifact_path(character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION parse_artifact_path(path character varying); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN document_types.acceptance_required; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN document_types.accepted_by_role; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN documents.accepted_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN documents.accepted_by; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN documents.rejected_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN documents.rejected_by; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN documents.rejection_reason; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE role_tasks; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN role_tasks.task_name; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN role_tasks.task_prompt; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN role_tasks.expected_schema; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN roles.identity_prompt; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: role_tasks uq_role_task; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_document_types_required_inputs; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_documents_unique_latest; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_role_tasks_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_role_tasks_lookup; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_role_tasks_role_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: documents fk_documents_doc_type; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: document_relations fk_relations_from_doc; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: document_relations fk_relations_to_doc; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict tSzIgJQzebDhdyQWIexuEuWGAd22rZ85nyuabohifXIURt36X5EM4tZb4UENeeE
